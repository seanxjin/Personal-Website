            ...
            <Star_texture>
                ...
                >
                    ...
                    <div id="projects-card-container">
                        ...
                        <ProjectCard image="/BrickBreaker.png" title="Brick Breaker" description="Hello" date="2024 Jan - 2024 Mar" skills={["Python", "SQlite3"]}/>
                    </div>
                </motion.div>
                ...
                <div style={{ width: "100%", display: "flex", justifyContent: "space-between", marginTop: "4rem" }}>
                    ...
                    <Button1 name="Home" link="/" left={false} />
                </div>
                <Footer/>
                </div>
            </Star_texture>
